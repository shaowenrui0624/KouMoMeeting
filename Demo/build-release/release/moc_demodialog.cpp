...
void DemoDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (DemoDialog::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DemoDialog::SIG_close)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (DemoDialog::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DemoDialog::SIG_joinRoom)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (DemoDialog::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DemoDialog::SIG_createRoom)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (DemoDialog::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DemoDialog::SIG_setUser)) {
                *result = 3;
                return;
            }
        }
