...
public:
    ...
    void setupUi(QWidget *UserShow)
    {
        if (UserShow->objectName().isEmpty())
            UserShow->setObjectName(QStringLiteral("UserShow"));
        UserShow->resize(200, 170);
        UserShow->setMinimumSize(QSize(200, 170));
        QFont font;
        font.setFamily(QString::fromUtf8("\345\276\256\350\275\257\351\233\205\351\273\221"));
        UserShow->setFont(font);
        UserShow->setStyleSheet(QLatin1String("background-color: rgb(0, 0, 0);\n"
"color: rgb(255, 255, 255);"));
    ...
    {
        UserShow->setWindowTitle(QApplication::translate("UserShow", "Form", 0));
        lb_name->setText(QApplication::translate("UserShow", "sha,lan", 0));
    } // retranslateUi
