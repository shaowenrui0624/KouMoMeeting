...
const QMetaObject UserShow::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_UserShow.data,
      qt_meta_data_UserShow,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *UserShow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_UserShow.stringdata0))
        return static_cast<void*>(const_cast< UserShow*>(this));
