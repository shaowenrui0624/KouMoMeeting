...
public:
    ...
    void setupUi(QDialog *DemoDialog)
    {
        ...
        wdg_content->setStyleSheet(QLatin1String("background-color: rgb(150,150,150);\n"
...
""));
        ...
        lb_title_icon->setObjectName(QStringLiteral("lb_title_icon"));
        ...
        QIcon icon;
        icon.addFile(QStringLiteral(":/tx/22.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        pb_join->setStyleSheet(QStringLiteral(""));
        QIcon icon2;
        icon2.addFile(QStringLiteral(":/images/00.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon3;
        icon3.addFile(QStringLiteral(":/images/01.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon4;
        icon4.addFile(QStringLiteral(":/images/02.png"), QSize(), QIcon::Normal, QIcon::Off);
    ...
    void retranslateUi(QDialog *DemoDialog)
    {
        ...
        lb_title->setText(QApplication::translate("DemoDialog", "\345\217\243\350\230\221\344\274\232\350\256\256", 0));
        pb_min->setText(QApplication::translate("DemoDialog", "\342\200\224", 0));
